...
public class Nor_female_02 {
	
	//Female 21-40 - normset
	...
	public static void main(String[] args) throws InterruptedException, IOException, AWTException {
		...
		driver.findElement(By.xpath("//input[@id='email']")).sendKeys("yogitha@energetics.ai");
		...
		PDDocument PDDoc = PDDocument.load(bf, "032000");
		...
		boolean DomainResult = pagecontent04.contains("10\r\n"+ "16\r\n"+ "8\r\n"+ "21\r\n"+ "27");
		...
		boolean ConscientiousnessResult = pagecontent06.contains("0.03\r\n" + "62\r\n" + "4\r\n" + "8\r\n" + "31\r\n" + "79");
		...
		boolean AgreeablenessResult = pagecontent08.contains("21\r\n" + "31\r\n" + "3\r\n" + "54\r\n" + "82\r\n" + "12");
		...
		boolean NeuroticismResult = pagecontent09.contains("8\r\n" + "24\r\n" + "42\r\n" + "27\r\n" + "62\r\n" + "42");
