...
public class Nor_female_03 {
	
	//Female 41-60 - normset
	...
	public static void main(String[] args) throws InterruptedException, IOException, AWTException {
		...
		driver.findElement(By.xpath("//input[@id='email']")).sendKeys("hemamalini@energetics.ai");
		...
		for (int i = 1; i<=120 ; i++) {
			...
			WebElement option = driver.findElement(By.xpath("//label[contains(text(),'Neither Accurate nor Inaccurate')]"));
		...
		PDDocument PDDoc = PDDocument.load(bf, "061975");
		...
		boolean OpennessResult = pagecontent05.contains("24\r\n" + "10\r\n" + "4\r\n" + "42\r\n" + "21\r\n" + "54");
		...
		boolean ConscientiousnessResult = pagecontent06.contains("2\r\n" + "38\r\n" + "1\r\n" + "3\r\n" + "24\r\n" + "27");
		...
		boolean ExtraversionResult = pagecontent07.contains("27\r\n" + "62\r\n" + "24\r\n" + "38\r\n" + "62\r\n" + "18");
		...
		boolean AgreeablenessResult = pagecontent08.contains("31\r\n" + "0.26\r\n" + "2\r\n" + "4\r\n" + "34\r\n" + "8");
		...
		boolean NeuroticismResult = pagecontent09.contains("50\r\n" + "58\r\n" + "69\r\n" + "50\r\n" + "50\r\n" + "69");
