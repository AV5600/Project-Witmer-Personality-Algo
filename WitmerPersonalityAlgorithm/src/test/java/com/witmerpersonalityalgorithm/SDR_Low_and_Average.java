...
public class SDR_Low_and_Average {
	...
	public static void main(String[] args) throws InterruptedException, IOException, AWTException {
		...
		for (int i = 1; i<=120 ; i++) {
			 ...
			 WebElement option1 = Personality_Question_Option.option1(driver); WebElement option4 = Personality_Question_Option.option4(driver); 
			 WebElement option5 = Personality_Question_Option.option5(driver);
			 
			 wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//span[@class='ass-intro-title ass-questions']")));
			 ...
			 //Actual score (value will be 5=5)
			 
			 if (questionText.contains(question39) || questionText.contains(question75) || 
			     questionText.contains(question109)) {

						option5.click(); Thread.sleep(500);
						
			 //Actual score (value will be 5=5)
						
			 } else if (questionText.contains(question45)) {
				 
				        option1.click(); Thread.sleep(500);
				        
			 //Reversed score (value will be 1=5)
				        
			 } else if (questionText.contains(question41)) {
				 
				        option5.click(); Thread.sleep(500);
				        
		     //Reversed score (value will be 1=5) 
			 } else if (questionText.contains(question101) || questionText.contains(question51) ||
					    questionText.contains(question81)) {
			 ...
			 //Others questions	        
					    ...
					    questionText.contains(question40) || questionText.contains(question42) ||
					    questionText.contains(question44) || questionText.contains(question46) || 
					    questionText.contains(question49) || questionText.contains(question50) ||
					    questionText.contains(question52) || questionText.contains(question47) ||
					    ...
					    questionText.contains(question74) || questionText.contains(question76) || 
					    questionText.contains(question79) || questionText.contains(question80) ||
					    questionText.contains(question82) || questionText.contains(question77) ||
					    ...
					    questionText.contains(question102) || questionText.contains(question104) || 
					    questionText.contains(question106) || questionText.contains(question107) ||
					    questionText.contains(question110) || questionText.contains(question105) ||
					    ...
					    questionText.contains(question03) || questionText.contains(question08) || 
						...
						questionText.contains(question48) || questionText.contains(question53) ||
		...
		//System.out.println(pagecontent09);
		
		String sdr_low_and_average = "Your results are likely a trustworthy representation of your true personality.";
		
		if (pagecontent09.contains(sdr_low_and_average)) {
			
			System.out.println("'SRD Content for Low and Average' are Correct");
			
		} else {
			
			System.out.println("'SRD Content for Low and Average' are InCorrect");
		}
