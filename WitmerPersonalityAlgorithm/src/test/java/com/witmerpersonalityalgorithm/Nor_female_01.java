...
public class Nor_female_01 {

	//Female 10-20 - normset
	...
	public static void main(String[] args) throws InterruptedException, IOException, AWTException {
		...
		driver.findElement(By.xpath("//input[@id='email']")).sendKeys("devices@energetics.ai");
		...
		for (int i = 1; i<=120 ; i++) {
			...
			WebElement option = driver.findElement(By.xpath("//label[contains(text(),'Moderately Inaccurate')]"));
		...
		//Moderately Inaccurate                                o          c        e        a         n
		
		boolean DomainResult = pagecontent04.contains("8\r\n"+ "31\r\n"+ "5\r\n"+ "27\r\n"+ "24");
		...
		boolean OpennessResult = pagecontent05.contains("0.13\r\n" + "12\r\n" + "8\r\n" + "62\r\n" + "38\r\n" + "46");
		...
		boolean ConscientiousnessResult = pagecontent06.contains("0.13\r\n" + "76\r\n" + "10\r\n" + "21\r\n" + "42\r\n" + "84");
		...
		boolean ExtraversionResult = pagecontent07.contains("24\r\n" + "42\r\n" + "14\r\n" + "18\r\n" + "3\r\n" + "2");
		...
		boolean AgreeablenessResult = pagecontent08.contains("18\r\n" + "46\r\n" + "4\r\n" + "69\r\n" + "76\r\n" + "10");
		...
		boolean NeuroticismResult = pagecontent09.contains("7\r\n" + "24\r\n" + "38\r\n" + "27\r\n" + "69\r\n" + "34");
