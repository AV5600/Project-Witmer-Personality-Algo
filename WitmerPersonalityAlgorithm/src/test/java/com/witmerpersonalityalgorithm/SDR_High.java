...
public class SDR_High {
	...
	public static void main(String[] args) throws InterruptedException, IOException, AWTException {
		...
		String sdr_high = "Your result indicates a preference for favorable responses, leaning towards a more favourable self-\r\n"
				          + "presentation.";
		
		if (pagecontent09.contains(sdr_high)) {
			
			System.out.println("'SRD Content for High' are Correct");
			
		} else {
			
			System.out.println("'SRD Content for High' are Incorrect");
		}
